...
\item The st and sp ligatures are broken up for place names that end in -town, -ton (usually short for -town), and -port. Examples: Charleston, Keyesport, and Hyannisport. Likewise, the \emph{\uselig{\ebg sk}} ligature is broken up for the place names \emph{\ebg Catskills} and \emph{\ebg Peekskill}, as the relevant morpheme is \emph{\ebg kill}, not \emph{\ebg skill}.
\end{itemize}
