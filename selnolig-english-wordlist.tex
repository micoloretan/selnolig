...
\item { \ebg \uselig{fb}, \uselig{fh}, \uselig{fj}, and \uselig{fk} ligatures}: suppressed \emph{globally}
...
Note: The test words in the remainder of this document are generally set in \emph{italics} because the upright shapes of the text fonts used in this document (Garamond Premier Pro and EB~Garamond) do not feature the ligatures \emph{th, at, et, as, {\ebg es}, is, us, {\ebg sk}, ll, and \uselig{ij}}.
...
{\ebg entireties sureties safeties (EB Garamond for ``es'' lig.)}
...
ultrasound ultrasophisticated asea

infrastructure seastrand 
...
\emph{Don't use \emph{is} in words containing ish, ism, and iss}: 

abolish accomplish actorish admonish amateurish anguish antitarnish apish astonish babyish bairnish bakshish baldish banish beamish bearish beauish biggish bitterish blackish blandish bleakish blemish blimpish blockish blondish blueish boarish boggish bookish boorish bounderish boyish brackish brainish brandish brassish brattish brinish broadish broguish brownish brutish buccaneerish buckish buffoonish bullish bumpkinish burnish caddish 

angelfish damselfish \emph{[contains ``elfish'']}

anglerfish archerfish batfish billfish blackfish  blindfish blowfish bluefish boarfish bonefish boxfish buffalofish butterfish candlefish

amiss bekiss bliss dismiss diss edelweiss gneiss hiss kiss miss outkiss priss remiss speiss submiss swiss 

asp aspish (better: a\uselig{sp}, a\uselig{sp}ish)
...
\ \ \ \emph{but:} \uselig{mis}\-think \uselig{mis}\-throw \uselig{cal\-is}\-thenic
...
\subsection*{Cases of \emph{as}-, {\em\ebg es}, \emph{is}-, and \emph{us}-ligatures pre-empting use of  \emph{sp}-ligature}
...
\ \ \ \ either as ``\texttt{a\textbackslash kern0pt sp}'' or as ``\texttt{a\textbackslash uselig\{sp\}ish}''. Ditto\\
\ \ \ \ for \texttt{aspish}.}
