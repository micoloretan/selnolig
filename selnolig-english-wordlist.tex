...
\subsection*{Part 1: f-ligatures suppressed in any case}
...
\subsection*{Part 2: Further f-ligatures suppressed if ``broad-f'' option is set}
...
\subsection*{Part-3: Ligatures suppressed if ``hdlig'' option is set}

\begin{itemize}

\item ct ligatures

arctangent coarctation Antarctica arctic antarctic
...
\subsection*{Part 4: Cases where one ligature pre-empts the use of a subsequent ligature}

\subsubsection*{Cases of \emph{as}, \emph{is}, and \emph{us} ligatures pre-empting use of \emph{st} ligature}
...
\subsubsection*{Cases of \emph{at} and \emph{et} ligatures pre-empting a \emph{th} ligature}
...
\subsubsection*{Cases of \emph{as}-, \emph{is}-, and \emph{us}-ligatures pre-empting use an \emph{sp}-ligature}
...
\subsubsection*{Cases of an \emph{et} ligature pre-empting a \emph{ta} ligature}
